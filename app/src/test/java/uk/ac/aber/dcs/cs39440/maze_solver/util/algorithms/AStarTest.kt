...
class AStarTest {
    ...
    @Test
    fun `A star running through all maze combinations, true on completion`() = runBlocking {
    ...
    @Test
    fun `A star running through unsolvable maze, false on completion`() = runBlocking {
        mazeMap = randomizedDfsMazeGenerator(
            mazeMap = mazeMap,
