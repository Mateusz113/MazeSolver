...
class BidirectionalSearchTest {
    ...
    @Test
    fun `Bidirectional search running through all maze combinations, true on completion`() = runBlocking {
    ...
    @Test
    fun `Bidirectional search running through unsolvable maze, false on completion`() = runBlocking {
        mazeMap = randomizedDfsMazeGenerator(
            mazeMap = mazeMap,
